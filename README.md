...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-15 14:25 CST.** All 16 paired pulls are complete and all 480 windows exist. Three hundred thirty-one equilibrations and forty-nine production windows are complete; 20 equilibrations plus 106 production windows use 126 real `mdrun` processes and 126/126 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
**Last synchronized monitor snapshot:** `2026-07-15 14:25 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.82 days</code></strong><br><sub>126-thread measured-rate schedule</sub></td>
      <td>All pulls are complete; 331 EQ and 49 production windows are done; 106 production windows are active.</td>
    </tr>
    <tr>
