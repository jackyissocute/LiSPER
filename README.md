...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-20 09:40 CST.** All 16 paired pulls are complete and all 480 windows exist; 371 EQ windows and 48 production windows are complete, 11 EQ jobs are active, and 115 production windows are active. Live `/proc` verification found 126 unique, advancing `mdrun` processes using 126/126 MD threads in distinct directories, with no active fatal, water-SETTLE, or LINCS warning.
>
...
**Last synchronized monitor snapshot:** `2026-07-20 09:40 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>🔵 16/16 pulls done; 371/480 EQ done + 11 active; 48/480 production done + 115 active</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>LiCl EQ 24/30 · 6 left · 0 active; PROD 1/30 · 29 left · 14 active</code><br><code>NaCl EQ 22/30 · 8 left · 0 active; PROD 2/30 · 28 left · 4 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 26/30 · 4 left · 1 active; PROD 0/30 · 30 left · 13 active</code><br><code>NaCl EQ 27/30 · 3 left · 0 active; PROD 0/30 · 30 left · 9 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 19/30 · 11 left · 0 active; PROD 1/30 · 29 left · 6 active</code><br><code>NaCl EQ 20/30 · 10 left · 0 active; PROD 1/30 · 29 left · 4 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 27/30 · 3 left · 0 active; PROD 4/30 · 26 left · 6 active</code><br><code>NaCl EQ 25/30 · 5 left · 0 active; PROD 4/30 · 26 left · 6 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 30/30 · 0 left · 0 active; PROD 14/30 · 16 left · 4 active</code><br><code>NaCl EQ 27/30 · 3 left · 0 active; PROD 19/30 · 11 left · 1 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 21/30 · 9 left · 1 active; PROD 1/30 · 29 left · 4 active</code><br><code>NaCl EQ 20/30 · 10 left · 4 active; PROD 1/30 · 29 left · 9 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~4.46 days</code></strong><br><sub>38.26M atom·ns progress-adjusted queue</sub></td>
      <td>All pulls are complete, 371 EQ windows and 48 production windows are complete, 11 EQ windows are active, and 115 production windows are active. Latest 179-minute same-host/protocol progress basis: 8.58M atom·ns/day; production throughput will continue to recalibrate the forecast.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-24 ~20:43 CST</code></strong><br><sub>±20% throughput band: Jul 24 02:52–Jul 25 23:28 CST</sub></td>
