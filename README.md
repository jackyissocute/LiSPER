...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-15 01:08 CST.** All 16 paired pulls are complete and all 480 windows exist. Two hundred seventy-six equilibrations and fifteen production windows are complete; 46 equilibrations plus 80 production windows use 126 real `mdrun` processes and 126/126 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
**Last synchronized monitor snapshot:** `2026-07-15 01:08 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~6.35 days</code></strong><br><sub>126-thread measured-rate schedule</sub></td>
      <td>All pulls are complete; 276 EQ and 15 production windows are done; 80 production windows are active.</td>
    </tr>
    <tr>
