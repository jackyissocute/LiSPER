...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-17 15:52 CST.** All 16 paired pulls are complete and all 480 windows exist. Three hundred eighty-two equilibrations and 160 production windows are complete; 23 equilibration and 103 production windows use 126 unique one-thread `mdrun` processes. Two threads remain reserved for launch, verification, monitoring, and analysis; no current fatal, water-SETTLE, or LINCS error is present.
>
