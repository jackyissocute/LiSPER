...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-15 12:08 CST.** All 16 paired pulls are complete and all 480 windows exist. Three hundred twenty-two equilibrations and forty-two production windows are complete; 27 equilibrations plus 99 production windows use 126 real `mdrun` processes and 126/126 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
**Last synchronized monitor snapshot:** `2026-07-15 12:08 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.91 days</code></strong><br><sub>126-thread measured-rate schedule</sub></td>
      <td>All pulls are complete; 322 EQ and 42 production windows are done; 99 production windows are active.</td>
    </tr>
    <tr>
