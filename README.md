...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-20 03:16 CST.** All 16 paired pulls are complete and all 480 windows exist; 362 EQ windows and 31 production windows are complete, 13 EQ jobs are active, and 113 production windows are active. Live `/proc` verification found 126 unique, advancing `mdrun` processes using 126/126 MD threads in distinct directories, with no active fatal, water-SETTLE, or LINCS warning.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-13_EQ_%2B_113_PROD-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-20 03:16 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 126 mdrun · 126 / 126 MD threads</code> <sub>13 one-thread EQ + 113 one-thread production; 2 support threads reserved</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 16/16 pulls done; 362/480 EQ done + 13 active; 31/480 production done + 113 active</code></td>
      <td><img alt="paired umbrella work running" src="https://img.shields.io/badge/active-13_EQ_%2B_113_PROD-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>LiCl EQ 24/30 · 6 left · 0 active; PROD 0/30 · 30 left · 14 active</code><br><code>NaCl EQ 21/30 · 9 left · 1 active; PROD 0/30 · 30 left · 5 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 25/30 · 5 left · 1 active; PROD 0/30 · 30 left · 9 active</code><br><code>NaCl EQ 27/30 · 3 left · 0 active; PROD 0/30 · 30 left · 8 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 19/30 · 11 left · 0 active; PROD 0/30 · 30 left · 6 active</code><br><code>NaCl EQ 20/30 · 10 left · 0 active; PROD 0/30 · 30 left · 5 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 27/30 · 3 left · 0 active; PROD 1/30 · 29 left · 8 active</code><br><code>NaCl EQ 25/30 · 5 left · 0 active; PROD 1/30 · 29 left · 8 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 30/30 · 0 left · 0 active; PROD 14/30 · 16 left · 2 active</code><br><code>NaCl EQ 27/30 · 3 left · 0 active; PROD 15/30 · 15 left · 4 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 19/30 · 11 left · 2 active; PROD 0/30 · 30 left · 4 active</code><br><code>NaCl EQ 18/30 · 12 left · 4 active; PROD 0/30 · 30 left · 9 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 12/30 · 18 left · 4 active; PROD 0/30 · 30 left · 4 active</code><br><code>NaCl EQ 16/30 · 14 left · 1 active; PROD 0/30 · 30 left · 4 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~4.76 days</code></strong><br><sub>40.55M atom·ns progress-adjusted queue</sub></td>
      <td>All pulls are complete, 362 EQ windows and 31 production windows are complete, 13 EQ windows are active, and 113 production windows are active. Latest 207-minute same-host/protocol progress basis: 8.53M atom·ns/day; production throughput will continue to recalibrate the forecast.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-24 ~21:25 CST</code></strong><br><sub>±20% throughput band: Jul 24 02:24–Jul 26 01:57 CST</sub></td>
