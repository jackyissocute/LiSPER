...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-18 11:57 CST.** Four paired pulls are complete and 12 remain active. One hundred twenty windows now exist; 42 LiDA-1 EQ jobs are active. Live `/proc` verification found 54 unique, advancing `mdrun` processes using 126/126 MD threads in distinct directories, with no active fatal, water-SETTLE, or LINCS warning.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-12_pulls_%2B_42_EQ-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-18 11:57 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 54 mdrun · 126 / 126 MD threads</code> <sub>12 seven-thread pulls + 42 one-thread EQ; 2 support threads reserved</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 4/16 pulls done · 12 active; 0/480 EQ done + 42 active; 0/480 production</code></td>
      <td><img alt="paired umbrella work running" src="https://img.shields.io/badge/active-12_pulls_%2B_42_EQ-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 0/30 · 30 left · 30 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 0/30 · 30 left · 12 active; PROD 0/30 · 30 left · 0 active</code></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.95 days</code></strong><br><sub>54.69M atom·ns progress-adjusted queue</sub></td>
      <td>Four pulls are complete, 12 remain active, and 42 EQ windows are active. New one-thread production throughput will recalibrate the forecast.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-24 ~14:50 CST</code></strong><br><sub>±20% throughput band: Jul 23 15:00–Jul 26 02:30 CST</sub></td>
