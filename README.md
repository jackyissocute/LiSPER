...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-19 05:00 CST.** All 16 paired pulls are complete and all 480 windows exist; 208 EQ windows and 3 production windows are complete, 93 EQ jobs are active, and 33 production windows are active. Live `/proc` verification found 126 unique, advancing `mdrun` processes using 126/126 MD threads in distinct directories, with no active fatal, water-SETTLE, or LINCS warning.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-93_EQ_%2B_33_PROD-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-19 05:00 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 126 mdrun · 126 / 126 MD threads</code> <sub>93 one-thread EQ + 33 one-thread production; 2 support threads reserved</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 16/16 pulls done; 208/480 EQ done + 93 active; 3/480 production done + 33 active</code></td>
      <td><img alt="paired umbrella work running" src="https://img.shields.io/badge/active-93_EQ_%2B_33_PROD-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>LiCl EQ 17/30 · 13 left · 2 active; PROD 0/30 · 30 left · 2 active</code><br><code>NaCl EQ 15/30 · 15 left · 4 active; PROD 0/30 · 30 left · 2 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 0/30 · 30 left · 18 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 0/30 · 30 left · 20 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 16/30 · 14 left · 0 active; PROD 0/30 · 30 left · 1 active</code><br><code>NaCl EQ 12/30 · 18 left · 0 active; PROD 0/30 · 30 left · 1 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 30/30 · 0 left · 0 active; PROD 3/30 · 27 left · 10 active</code><br><code>NaCl EQ 27/30 · 3 left · 0 active; PROD 0/30 · 30 left · 10 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 8/30 · 22 left · 8 active; PROD 0/30 · 30 left · 1 active</code><br><code>NaCl EQ 8/30 · 22 left · 5 active; PROD 0/30 · 30 left · 2 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 6/30 · 24 left · 4 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 8/30 · 22 left · 1 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.48 days</code></strong><br><sub>48.56M atom·ns progress-adjusted queue</sub></td>
      <td>All pulls are complete, 208 EQ windows and 3 production windows are complete, 93 EQ windows are active, and 33 production windows are active. Latest one-hour same-host/protocol progress basis: 8.86M atom·ns/day; production throughput will continue to recalibrate the forecast.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-24 ~16:33 CST</code></strong><br><sub>±20% throughput band: Jul 23 18:38–Jul 26 01:27 CST</sub></td>
