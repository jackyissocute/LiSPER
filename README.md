...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-18 23:00 CST.** All 16 paired pulls are complete and all 480 windows exist; 151 EQ windows are complete, 105 EQ jobs are active, and 21 production windows are active. Live `/proc` verification found 126 unique, advancing `mdrun` processes using 126/126 MD threads in distinct directories, with no active fatal, water-SETTLE, or LINCS warning.
>
...
**Last synchronized monitor snapshot:** `2026-07-18 23:00 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 126 mdrun · 126 / 126 MD threads</code> <sub>105 one-thread EQ + 21 one-thread production; 2 support threads reserved</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 16/16 pulls done; 151/480 EQ done + 105 active; 0/480 production done + 21 active</code></td>
      <td><img alt="paired umbrella work running" src="https://img.shields.io/badge/active-105_EQ_%2B_21_PROD-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>LiCl EQ 7/30 · 23 left · 11 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 9/30 · 21 left · 7 active; PROD 0/30 · 30 left · 0 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 0/30 · 30 left · 11 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 0/30 · 30 left · 10 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 0/30 · 30 left · 15 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 0/30 · 30 left · 18 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 14/30 · 16 left · 2 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 6/30 · 24 left · 6 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 4/30 · 26 left · 6 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 4/30 · 26 left · 7 active; PROD 0/30 · 30 left · 1 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 4/30 · 26 left · 3 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 5/30 · 25 left · 4 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.52 days</code></strong><br><sub>50.76M atom·ns progress-adjusted queue</sub></td>
      <td>All pulls are complete, 151 EQ windows are complete, 105 EQ windows are active, and 21 production windows are active. Production throughput will recalibrate the forecast.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-24 ~15:34 CST</code></strong><br><sub>±20% throughput band: Jul 23 17:28–Jul 26 00:42 CST</sub></td>
