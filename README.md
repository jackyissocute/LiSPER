...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-15 17:06 CST.** All 16 paired pulls are complete and all 480 windows exist. Three hundred thirty-four equilibrations and fifty-one production windows are complete; 19 equilibrations plus 107 production windows use 126 real `mdrun` processes and 126/126 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-39_eq_%2B_87_prod-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-15 17:06 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 126 mdrun · 126 / 126 threads</code> <sub>49 equilibrations + 77 production</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 257 EQ + 13 PROD done · 49 EQ + 77 production running</code></td>
      <td><img alt="paired window MD running" src="https://img.shields.io/badge/active-49_eq_%2B_77_prod-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.71 days</code></strong><br><sub>126-thread measured-rate schedule</sub></td>
      <td>All pulls are complete; 334 EQ and 51 production windows are done; 107 production windows are active.</td>
    </tr>
    <tr>
