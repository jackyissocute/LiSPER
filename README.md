...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-15 02:08 CST.** All 16 paired pulls are complete and all 480 windows exist. Two hundred seventy-nine equilibrations and seventeen production windows are complete; 45 equilibrations plus 81 production windows use 126 real `mdrun` processes and 126/126 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
**Last synchronized monitor snapshot:** `2026-07-15 02:08 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~6.31 days</code></strong><br><sub>126-thread measured-rate schedule</sub></td>
      <td>All pulls are complete; 279 EQ and 17 production windows are done; 81 production windows are active.</td>
    </tr>
    <tr>
