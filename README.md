...
I'm Yukun Lin (Jacky), and **LiSPER (Lithium-Selective Peptide Engineering and Recovery)** is my Signature Work at Duke Kunshan University, supervised by Ferdinand Kappes. I started with computational peptide design and am now preparing to test whether the designs can capture lithium from mixed-ion solutions. My long-term goal is to help recover lithium from spent batteries and other waste streams.

I have completed the computational work and plasmid designs. The next steps are to test the biology and, if it works, make a recoverable material.
...
| Surface-display design | The final [pET-11a design package](02_experimental_validation/plasmids/pET-11a/README.md) contains four peptide fusions, three scaffold controls, and the reference backbone. I have sent the designs to the vendor. | Verify fusion expression and accessible display after the constructs arrive. |
