...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-14 10:10 CST.** All 16 paired pulls are complete and all 480 windows exist. One hundred thirty-one equilibrations are complete; 98 equilibrations plus 26 production windows use 124 real `mdrun` processes and 124/124 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-98_eq_%2B_26_prod-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-14 10:10 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 124 mdrun · 124 / 124 threads</code> <sub>98 equilibrations + 26 production</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 131 EQ done · 98 EQ + 26 production running</code></td>
      <td><img alt="paired window MD running" src="https://img.shields.io/badge/active-98_eq_%2B_26_prod-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~6.91 days</code></strong><br><sub>full-pool measured-rate schedule</sub></td>
      <td>All pulls are complete; 131 EQ are done and 26 production windows are active.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-21 ~12:05 CST</code></strong><br><sub>90% band 08:25–14:15 CST</sub></td>
