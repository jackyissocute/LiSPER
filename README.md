...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-16 01:06 CST.** All 16 paired pulls are complete and all 480 windows exist. Three hundred fifty equilibrations and seventy-four production windows are complete; 8 equilibrations plus 116 production windows use 124 real `mdrun` processes and 124/126 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
**Last synchronized monitor snapshot:** `2026-07-16 01:06 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.38 days</code></strong><br><sub>measured-rate schedule</sub></td>
      <td>All pulls are complete; 350 EQ and 74 production windows are done; 116 production windows are active.</td>
    </tr>
    <tr>
