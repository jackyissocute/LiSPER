...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-22 15:57 CST.** All 16 paired pulls are complete and all 480 windows exist; 437 EQ windows and 233 production windows are complete, 8 EQ jobs are active, and 118 production windows are active. Live `/proc` verification found 126 unique, advancing `mdrun` processes using 126/126 MD threads in distinct directories, with no active fatal, water-SETTLE, or LINCS warning.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-8_EQ_%2B_118_PROD-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-22 15:57 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 126 mdrun · 126 / 126 MD threads</code> <sub>8 one-thread EQ + 118 one-thread production; 2 support threads reserved</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 16/16 pulls done; 437/480 EQ done + 8 active; 233/480 production done + 118 active</code></td>
      <td><img alt="paired umbrella work running" src="https://img.shields.io/badge/active-8_EQ_%2B_118_PROD-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 30/30 · 0 left · 0 active; PROD 15/30 · 15 left · 13 active</code><br><code>NaCl EQ 30/30 · 0 left · 0 active; PROD 11/30 · 19 left · 18 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 27/30 · 3 left · 3 active; PROD 11/30 · 19 left · 16 active</code><br><code>NaCl EQ 30/30 · 0 left · 0 active; PROD 17/30 · 13 left · 13 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 25/30 · 5 left · 0 active; PROD 9/30 · 21 left · 4 active</code><br><code>NaCl EQ 24/30 · 6 left · 2 active; PROD 8/30 · 22 left · 5 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 28/30 · 2 left · 0 active; PROD 21/30 · 9 left · 0 active</code><br><code>NaCl EQ 27/30 · 3 left · 0 active; PROD 20/30 · 10 left · 2 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 30/30 · 0 left · 0 active; PROD 23/30 · 7 left · 3 active</code><br><code>NaCl EQ 30/30 · 0 left · 0 active; PROD 30/30 · 0 left · 0 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 26/30 · 4 left · 1 active; PROD 10/30 · 20 left · 10 active</code><br><code>NaCl EQ 29/30 · 1 left · 1 active; PROD 14/30 · 16 left · 9 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 25/30 · 5 left · 0 active; PROD 8/30 · 22 left · 10 active</code><br><code>NaCl EQ 20/30 · 10 left · 0 active; PROD 7/30 · 23 left · 3 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~2.11 days</code></strong><br><sub>18.59M atom·ns progress-adjusted queue</sub></td>
      <td>All pulls are complete, 437 EQ windows and 233 production windows are complete, 8 EQ windows are active, and 118 production windows are active. Latest 180-minute same-host/protocol progress basis: 8.81M atom·ns/day; production throughput will continue to recalibrate the forecast.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-24 ~18:37 CST</code></strong><br><sub>±20% throughput band: Jul 24 10:10–Jul 25 07:17 CST</sub></td>
