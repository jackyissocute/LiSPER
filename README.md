...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-15 11:07 CST.** All 16 paired pulls are complete and all 480 windows exist. Three hundred eleven equilibrations and forty production windows are complete; 36 equilibrations plus 90 production windows use 126 real `mdrun` processes and 126/126 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
**Last synchronized monitor snapshot:** `2026-07-15 11:07 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.95 days</code></strong><br><sub>126-thread measured-rate schedule</sub></td>
      <td>All pulls are complete; 311 EQ and 40 production windows are done; 90 production windows are active.</td>
    </tr>
    <tr>
