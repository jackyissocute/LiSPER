...
**Last synchronized monitor snapshot:** `2026-07-06 21:01 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~1-4 days first paired QC; ~2-5 days broader table</code></strong><br><sub>LiDA-1 and LiDS-1 remain paired QC/repair-review limited. LiA3-Ref NaCl is now producing `008-009`; LiD3-Core LiCl is producing `008` and equilibrating `009`.</sub></td>
...
|---:|---|---|---|---|
| 1 | **LiD3-Core** | `GPGDPGPGDPGPGDP` | Linker-free GPGDP trimer benchmark | Refined LiCl V2 `8/27`, production `008` and equilibration `009`; NaCl V2 `8/27`, equilibrating `008-009` |
