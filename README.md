...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-19 10:14 CST.** All 16 paired pulls are complete and all 480 windows exist; 269 EQ windows and 16 production windows are complete, 71 EQ jobs are active, and 55 production windows are active. Live `/proc` verification found 126 unique, advancing `mdrun` processes using 126/126 MD threads in distinct directories, with no active fatal, water-SETTLE, or LINCS warning.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-71_EQ_%2B_55_PROD-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-19 10:14 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 126 mdrun · 126 / 126 MD threads</code> <sub>71 one-thread EQ + 55 one-thread production; 2 support threads reserved</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 16/16 pulls done; 269/480 EQ done + 71 active; 16/480 production done + 55 active</code></td>
      <td><img alt="paired umbrella work running" src="https://img.shields.io/badge/active-71_EQ_%2B_55_PROD-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 11/30 · 19 left · 14 active; PROD 0/30 · 30 left · 2 active</code><br><code>NaCl EQ 10/30 · 20 left · 15 active; PROD 0/30 · 30 left · 2 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 30/30 · 0 left · 0 active; PROD 11/30 · 19 left · 3 active</code><br><code>NaCl EQ 27/30 · 3 left · 0 active; PROD 5/30 · 25 left · 9 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 10/30 · 20 left · 1 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 9/30 · 21 left · 4 active; PROD 0/30 · 30 left · 2 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.38 days</code></strong><br><sub>46.63M atom·ns progress-adjusted queue</sub></td>
      <td>All pulls are complete, 269 EQ windows and 16 production windows are complete, 71 EQ windows are active, and 55 production windows are active. Latest 57-minute same-host/protocol progress basis: 8.67M atom·ns/day; production throughput will continue to recalibrate the forecast.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-24 ~19:16 CST</code></strong><br><sub>±20% throughput band: Jul 23 21:46–Jul 26 03:32 CST</sub></td>
