...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-15 23:07 CST.** All 16 paired pulls are complete and all 480 windows exist. Three hundred forty-nine equilibrations and sixty-six production windows are complete; 8 equilibrations plus 118 production windows use 126 real `mdrun` processes and 126/126 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
**Last synchronized monitor snapshot:** `2026-07-15 23:07 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.46 days</code></strong><br><sub>126-thread measured-rate schedule</sub></td>
      <td>All pulls are complete; 349 EQ and 66 production windows are done; 118 production windows are active.</td>
    </tr>
    <tr>
