...
**Last synchronized monitor snapshot:** `2026-07-07 01:06 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~1-4 days first paired QC; ~2-5 days broader table</code></strong><br><sub>LiDA-1 and LiDS-1 remain paired QC/repair-review limited. LiD3-Core LiCl/NaCl and LiLC-1 NaCl are now producing `008-009`.</sub></td>
...
| 4 | **LiLC-1** | `GPGDPGSGNPGSGDP` | Lower-charge selectivity-control design | LiCl V2 `1/27`, active `001`; NaCl `V2 8/27`, production `008-009` |
