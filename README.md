...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-15 20:07 CST.** All 16 paired pulls are complete and all 480 windows exist. Three hundred forty-four equilibrations and fifty-five production windows are complete; 11 equilibrations plus 115 production windows use 126 real `mdrun` processes and 126/126 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
**Last synchronized monitor snapshot:** `2026-07-15 20:07 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.58 days</code></strong><br><sub>126-thread measured-rate schedule</sub></td>
      <td>All pulls are complete; 344 EQ and 55 production windows are done; 115 production windows are active.</td>
    </tr>
    <tr>
