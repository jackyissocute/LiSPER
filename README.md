...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-23 15:57 CST.** All 16 paired pulls are complete and all 480 windows exist; 459 EQ windows and 311 production windows are complete, 8 EQ jobs are active, and 118 production windows are active. Live `/proc` verification found 126 unique, advancing `mdrun` processes using 126/126 MD threads in distinct directories, with no active fatal, water-SETTLE, or LINCS warning.
>
...
**Last synchronized monitor snapshot:** `2026-07-23 15:57 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>🔵 16/16 pulls done; 459/480 EQ done + 8 active; 311/480 production done + 118 active</code></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~1.07 days</code></strong><br><sub>9.66M atom·ns progress-adjusted queue</sub></td>
      <td>All pulls are complete, 459 EQ windows and 311 production windows are complete, 8 EQ windows are active, and 118 production windows are active. Latest 176-minute same-host/protocol progress basis: 9.00M atom·ns/day; production throughput will continue to recalibrate the forecast.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-24 ~17:43 CST</code></strong><br><sub>±20% throughput band: Jul 24 13:25–Jul 25 00:10 CST</sub></td>
