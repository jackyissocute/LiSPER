...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-13 13:10 CST.** Locked-site **LiLC-1** pilot on EPYC 9554P (128t). Pull and 0.5 ns window eq complete both ions; **2.0 ns window production** ~73% (60/60 windows, 0 failed, ~3.0 ns/day). 8/8 candidates `VALIDATED_BOUND`. ΔG promotion hold until pilot QC PASS.
>
...
> ![Pilot running](https://img.shields.io/badge/LiLC--1_locked_pilot-window_prod_~73%25-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-13 13:10 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>🔵 LiLC-1 locked window-prod ~73% (60/60 · 0 fail · ~3.0 ns/day)</code></td>
      <td><img alt="locked pilot window production" src="https://img.shields.io/badge/LiLC--1_locked-window_prod_~73%25-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>LiCl locked window-prod ~73%</code> 🟢 🟢 🟢 🔵 ◆⚫<br><code>NaCl locked window-prod ~73%</code> 🟢 🟢 🟢 🔵 ◆⚫</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~0.2 day (LiLC-1 pilot rem)</code></strong><br><sub>Live ~3.0 ns/day · production ~73%; ≈4.8 h remaining (60 parallel)</sub></td>
