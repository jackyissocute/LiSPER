...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-14 17:02 CST.** All 16 paired pulls are complete and all 480 windows exist. Two hundred ten equilibrations and one production window are complete; 64 equilibrations plus 60 production windows use 124 real `mdrun` processes and 124/124 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-64_eq_%2B_60_prod-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-14 17:02 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 124 mdrun · 124 / 124 threads</code> <sub>64 equilibrations + 60 production</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 210 EQ + 1 PROD done · 64 EQ + 60 production running</code></td>
      <td><img alt="paired window MD running" src="https://img.shields.io/badge/active-64_eq_%2B_60_prod-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>LiCl EQ active</code> 🟢 🟢 🔵 ⚫ ◆⚫<br><code>NaCl EQ active</code> 🟢 🟢 🔵 ⚫ ◆⚫</td>
    ...
    <tr>
      ...
      <td><code>LiCl 26 EQ done; PROD active</code> 🟢 🟢 🟢 🔵 ◆⚫<br><code>NaCl EQ active</code> 🟢 🟢 🔵 ⚫ ◆⚫</td>
      <td><img alt="paired window equilibration" src="https://img.shields.io/badge/paired_windows-equilibrating-38BDF8"></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~6.70 days</code></strong><br><sub>211 completed-stage rate schedule</sub></td>
      <td>All pulls are complete; 210 EQ and 1 production window are done; 60 production windows are active.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-21 ~14:00 CST</code></strong><br><sub>90% band 11:00–16:10 CST</sub></td>
