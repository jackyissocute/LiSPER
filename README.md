...
> ![LiCl](https://img.shields.io/badge/LiCl-3.36--11.57_ns_of_20_ns-2563eb)
...
**Last synchronized monitor snapshot:** `2026-06-19 20:25 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>3.36-11.57 ns / 20 ns</code> across 8 active jobs</td>
      <td><img alt="LiCl production progress" src="https://img.shields.io/badge/active-8%2F8_jobs-2563eb"></td>
      <td>Li+ ensemble trajectories; current leader <code>LiDA-1</code> at <code>11.57 ns</code></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>20 ns production MD</td>
      <td><code>1.43-5.15 ns / 20 ns</code> across 6 active jobs; queued jobs at <code>0.13-0.16 ns</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>🟦 <code>5.10 ns / 20 ns</code>; clustering queued</td>
      <td>🟦 <code>2.06 ns / 20 ns</code>; clustering queued</td>
      <td>🟪 planned after paired representatives</td>
      <td>🟪 planned after umbrella sampling</td>
    </tr>
    <tr>
      <td><strong>LiD3-Flex</strong></td>
      <td>🟦 <code>3.41 ns / 20 ns</code>; clustering queued</td>
      <td>🟦 <code>1.43 ns / 20 ns</code>; clustering queued</td>
      <td>🟪 planned after paired representatives</td>
      <td>🟪 planned after umbrella sampling</td>
    </tr>
    <tr>
      <td><strong>LiND-Hybrid</strong></td>
      <td>🟦 <code>3.36 ns / 20 ns</code>; clustering queued</td>
    ...
    <tr>
      ...
      <td>🟦 <code>5.22 ns / 20 ns</code>; clustering queued</td>
      <td>🟦 <code>2.30 ns / 20 ns</code>; clustering queued</td>
      <td>🟪 planned after paired representatives</td>
      <td>🟪 planned after umbrella sampling</td>
    </tr>
    <tr>
      <td><strong>LiDS-1</strong></td>
      <td>🟦 <code>7.92 ns / 20 ns</code>; clustering queued</td>
      <td>🟦 <code>3.50 ns / 20 ns</code>; clustering queued</td>
      <td>🟪 planned after paired representatives</td>
      <td>🟪 planned after umbrella sampling</td>
    </tr>
    <tr>
      <td><strong>LiDA-1</strong></td>
      <td>🟦 <code>11.57 ns / 20 ns</code>; clustering queued</td>
      <td>🟦 <code>5.15 ns / 20 ns</code>; clustering queued</td>
      <td>🟪 planned after paired representatives</td>
      <td>🟪 planned after umbrella sampling</td>
    </tr>
    <tr>
      <td><strong>LiN3-Core</strong></td>
      <td>🟦 <code>5.26 ns / 20 ns</code>; clustering queued</td>
    ...
    <tr>
      ...
      <td>🟦 <code>5.12 ns / 20 ns</code>; clustering queued</td>
      <td>🟦 <code>2.00 ns / 20 ns</code>; clustering queued</td>
      <td>🟪 planned after paired representatives</td>
      <td>🟪 planned after umbrella sampling</td>
    </tr>
  </tbody>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~14-35+ days</code></strong><br><sub>updated after continued post-optimization NaCl progress</sub></td>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~22-50+ days</code></strong><br><sub>production estimate improved after NaCl throughput stabilized</sub></td>
...
|---:|---|---|---|---|
| 1 | **LiD3-Core** | `GPGDPGPGDPGPGDP` | Linker-free GPGDP trimer benchmark | LiCl `5.10/20 ns`; NaCl `2.06/20 ns` |
| 2 | **LiD3-Flex** | `GPGDPGSGPGDPGSGPGDP` | Flexible GSG-spaced GPGDP trimer | LiCl `3.41/20 ns`; NaCl `1.43/20 ns` |
| 3 | **LiND-Hybrid** | `GPGNPGSGPGDPGSGPGNP` | Mixed GPGNP/GPGDP donor environment | LiCl `3.36/20 ns`; NaCl `0.16/20 ns queued` |
| 4 | **LiLC-1** | `GPGDPGSGNPGSGDP` | Lower-charge selectivity-control design | LiCl `5.22/20 ns`; NaCl `2.30/20 ns` |
| 5 | **LiDS-1** | `DGDGPGDPGDG` | Asp/Gly Li+/Na+ geometry probe | LiCl `7.92/20 ns`; NaCl `3.50/20 ns` |
| 6 | **LiDA-1** | `DADGPGDPDAG` | Ala-supported Asp pocket probe | LiCl `11.57/20 ns`; NaCl `5.15/20 ns` |
| 7 | **LiN3-Core** | `GPGNPGPGNPGPGNP` | GPGNP trimer benchmark | LiCl `5.26/20 ns`; NaCl `0.13/20 ns queued` |
| 8 | **LiA3-Ref** | `GPGAPGPGAPGPGAP` | Low-donor GPGAP reference | LiCl `5.12/20 ns`; NaCl `2.00/20 ns` |
