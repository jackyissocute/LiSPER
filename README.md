...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-16 02:07 CST.** All 16 paired pulls are complete and all 480 windows exist. Three hundred fifty-one equilibrations and seventy-five production windows are complete; 7 equilibrations plus 118 production windows use 125 real `mdrun` processes and 125/126 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
**Last synchronized monitor snapshot:** `2026-07-16 02:07 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.34 days</code></strong><br><sub>measured-rate schedule</sub></td>
      <td>All pulls are complete; 351 EQ and 75 production windows are done; 118 production windows are active.</td>
    </tr>
    <tr>
