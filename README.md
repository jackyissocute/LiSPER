...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-15 07:08 CST.** All 16 paired pulls are complete and all 480 windows exist. Two hundred ninety equilibrations and thirty-two production windows are complete; 47 equilibrations plus 79 production windows use 126 real `mdrun` processes and 126/126 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
**Last synchronized monitor snapshot:** `2026-07-15 07:08 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~6.11 days</code></strong><br><sub>126-thread measured-rate schedule</sub></td>
      <td>All pulls are complete; 290 EQ and 32 production windows are done; 79 production windows are active.</td>
    </tr>
    <tr>
