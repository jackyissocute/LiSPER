...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-18 13:58 CST.** Fourteen paired pulls are complete and 2 remain active. Four hundred twenty windows now exist; 28 EQ windows are complete, 111 EQ jobs are active, and the first production window is active. Live `/proc` verification found 114 unique, advancing `mdrun` processes using 126/126 MD threads in distinct directories, with no active fatal, water-SETTLE, or LINCS warning.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-2_pulls_%2B_111_EQ_%2B_1_PROD-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-18 13:58 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 114 mdrun · 126 / 126 MD threads</code> <sub>2 seven-thread pulls + 111 one-thread EQ + 1 one-thread production; 2 support threads reserved</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 14/16 pulls done · 2 active; 28/480 EQ done + 111 active; 0/480 production done + 1 active</code></td>
      <td><img alt="paired umbrella work running" src="https://img.shields.io/badge/active-2_pulls_%2B_111_EQ_%2B_1_PROD-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 0/30 · 30 left · 2 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 0/30 · 30 left · 4 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 0/30 · 30 left · 13 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 0/30 · 30 left · 3 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 0/30 · 30 left · 23 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 0/30 · 30 left · 19 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 28/30 · 2 left · 2 active; PROD 0/30 · 30 left · 1 active</code><br><code>NaCl EQ 0/30 · 30 left · 22 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 0/30 · 30 left · 3 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 0/30 · 30 left · 3 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.87 days</code></strong><br><sub>53.99M atom·ns progress-adjusted queue</sub></td>
      <td>Fourteen pulls are complete, 28 EQ windows are complete, 111 EQ windows are active, and the first production window is active. Production throughput will recalibrate the forecast.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-24 ~15:00 CST</code></strong><br><sub>±20% throughput band: Jul 23 15:30–Jul 26 02:15 CST</sub></td>
