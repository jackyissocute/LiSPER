...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-19 01:00 CST.** All 16 paired pulls are complete and all 480 windows exist; 181 EQ windows are complete, 99 EQ jobs are active, and 27 production windows are active. Live `/proc` verification found 126 unique, advancing `mdrun` processes using 126/126 MD threads in distinct directories, with no active fatal, water-SETTLE, or LINCS warning.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-99_EQ_%2B_27_PROD-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-19 01:00 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 126 mdrun · 126 / 126 MD threads</code> <sub>99 one-thread EQ + 27 one-thread production; 2 support threads reserved</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 16/16 pulls done; 181/480 EQ done + 99 active; 0/480 production done + 27 active</code></td>
      <td><img alt="paired umbrella work running" src="https://img.shields.io/badge/active-99_EQ_%2B_27_PROD-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>LiCl EQ 10/30 · 20 left · 8 active; PROD 0/30 · 30 left · 1 active</code><br><code>NaCl EQ 13/30 · 17 left · 4 active; PROD 0/30 · 30 left · 0 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 0/30 · 30 left · 14 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 0/30 · 30 left · 14 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 2/30 · 28 left · 15 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 3/30 · 27 left · 20 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 15/30 · 15 left · 1 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 10/30 · 20 left · 2 active; PROD 0/30 · 30 left · 1 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 25/30 · 5 left · 0 active; PROD 0/30 · 30 left · 1 active</code><br><code>NaCl EQ 19/30 · 11 left · 2 active; PROD 0/30 · 30 left · 1 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 30/30 · 0 left · 0 active; PROD 0/30 · 30 left · 12 active</code><br><code>NaCl EQ 27/30 · 3 left · 0 active; PROD 0/30 · 30 left · 9 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 8/30 · 22 left · 8 active; PROD 0/30 · 30 left · 1 active</code><br><code>NaCl EQ 8/30 · 22 left · 4 active; PROD 0/30 · 30 left · 1 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 5/30 · 25 left · 4 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 6/30 · 24 left · 3 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.50 days</code></strong><br><sub>50.00M atom·ns progress-adjusted queue</sub></td>
      <td>All pulls are complete, 181 EQ windows are complete, 99 EQ windows are active, and 27 production windows are active. Latest two-hour same-host/protocol progress basis: 9.09M atom·ns/day; production throughput will recalibrate the forecast.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-24 ~12:58 CST</code></strong><br><sub>±20% throughput band: Jul 23 14:59–Jul 25 21:58 CST</sub></td>
