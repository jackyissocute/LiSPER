...
| 2 | **LiD3-Flex** | `GPGDPGSGPGDPGSGPGDP` | Flexible GSG-spaced GPGDP trimer | Refined LiCl `17/27`, equilibration `012-015`; NaCl `17/27`, equilibration `017-021`; PMF QC pending final refined run |
...
| 4 | **LiLC-1** | `GPGDPGSGNPGSGDP` | Lower-charge selectivity-control design | LiCl V2 `2/27`, equilibration `002`; NaCl `V2 8/27`, production `008-009` |
