...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-19 08:15 CST.** All 16 paired pulls are complete and all 480 windows exist; 236 EQ windows and 16 production windows are complete, 89 EQ jobs are active, and 37 production windows are active. Live `/proc` verification found 126 unique, advancing `mdrun` processes using 126/126 MD threads in distinct directories, with no active fatal, water-SETTLE, or LINCS warning.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-89_EQ_%2B_37_PROD-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-19 08:15 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 126 mdrun · 126 / 126 MD threads</code> <sub>89 one-thread EQ + 37 one-thread production; 2 support threads reserved</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 16/16 pulls done; 236/480 EQ done + 89 active; 16/480 production done + 37 active</code></td>
      <td><img alt="paired umbrella work running" src="https://img.shields.io/badge/active-89_EQ_%2B_37_PROD-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>LiCl EQ 18/30 · 12 left · 3 active; PROD 0/30 · 30 left · 4 active</code><br><code>NaCl EQ 16/30 · 14 left · 3 active; PROD 0/30 · 30 left · 3 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 4/30 · 26 left · 19 active; PROD 0/30 · 30 left · 1 active</code><br><code>NaCl EQ 7/30 · 23 left · 16 active; PROD 0/30 · 30 left · 0 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 9/30 · 21 left · 12 active; PROD 0/30 · 30 left · 1 active</code><br><code>NaCl EQ 14/30 · 16 left · 13 active; PROD 0/30 · 30 left · 5 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 25/30 · 5 left · 0 active; PROD 0/30 · 30 left · 2 active</code><br><code>NaCl EQ 21/30 · 9 left · 0 active; PROD 0/30 · 30 left · 1 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 30/30 · 0 left · 0 active; PROD 11/30 · 19 left · 2 active</code><br><code>NaCl EQ 27/30 · 3 left · 0 active; PROD 5/30 · 25 left · 7 active</code></td>
    ...
    <tr>
      ...
      <td><code>LiCl EQ 10/30 · 20 left · 7 active; PROD 0/30 · 30 left · 2 active</code><br><code>NaCl EQ 11/30 · 19 left · 4 active; PROD 0/30 · 30 left · 3 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl EQ 7/30 · 23 left · 4 active; PROD 0/30 · 30 left · 0 active</code><br><code>NaCl EQ 9/30 · 21 left · 2 active; PROD 0/30 · 30 left · 1 active</code></td>
      <td><img alt="equilibration running" src="https://img.shields.io/badge/EQ-running-38BDF8"></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.54 days</code></strong><br><sub>47.37M atom·ns progress-adjusted queue</sub></td>
      <td>All pulls are complete, 236 EQ windows and 16 production windows are complete, 89 EQ windows are active, and 37 production windows are active. Latest 75-minute same-host/protocol progress basis: 8.55M atom·ns/day; production throughput will continue to recalibrate the forecast.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-24 ~21:09 CST</code></strong><br><sub>±20% throughput band: Jul 23 23:00–Jul 26 06:23 CST</sub></td>
