...
**Last synchronized monitor snapshot:** `2026-07-09 09:19 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>LiCl V2 10/27</code> 🟢 🟢 🟢 🔵 ◆⚫<br><code>NaCl V2 10/27</code> 🟢 🟢 🟢 🔵 ◆⚫</td>
    ...
    <tr>
      ...
      <td><code>LiCl V2 17/27</code> 🟢 🟢 🟢 🔵 ◆⚫<br><code>NaCl V2 19/27</code> 🟢 🟢 🟢 🔵 ◆⚫</td>
      <td><img alt="PMF planned" src="https://img.shields.io/badge/planned-PMF-64748B"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl V2 1/27</code> 🟢 🟢 🟢 🔵 ◆⚫<br><code>NaCl V2 2/27</code> 🟢 🟢 🟢 🔵 ◆⚫</td>
      <td><img alt="PMF planned" src="https://img.shields.io/badge/planned-PMF-64748B"></td>
    </tr>
    <tr>
      ...
      <td><code>LiCl V2 3/27</code> 🟢 🟢 🟢 🔵 ◆⚫<br><code>NaCl V2 10/27</code> 🟢 🟢 🟢 🔵 ◆⚫</td>
      <td><img alt="PMF planned" src="https://img.shields.io/badge/planned-PMF-64748B"></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~1-4 days first paired QC; ~2-5 days broader table</code></strong><br><sub>LiDA-1 and LiDS-1 remain paired QC/repair-review limited. LiD3-Flex NaCl reached V2 `19/27`, LiA3-Ref NaCl reached V2 `11/27`, and LiA3-Ref LiCl window `003` moved into production.</sub></td>
...
> Time estimates are based on the current GCP `25` real `mdrun` jobs using `25` OpenMP threads and `82%` data-disk use. All 20 ns production and clustering gates are closed. The first likely paired Delta Delta G table is still contested between LiDA-1 repair review and LiDS-1 paired V2 QC review; no Delta G is promoted before QC passes.
...
|---:|---|---|---|---|
| 1 | **LiD3-Core** | `GPGDPGPGDPGPGDP` | Linker-free GPGDP trimer benchmark | Refined LiCl V2 `10/27`, production `010-011`; NaCl V2 `10/27`, production `010-011` |
| 2 | **LiD3-Flex** | `GPGDPGSGPGDPGSGPGDP` | Flexible GSG-spaced GPGDP trimer | Refined LiCl `17/27`, production `012-015`; NaCl `19/27`, production `019-021`, equilibration `022-023`; PMF QC pending final refined run |
| 3 | **LiND-Hybrid** | `GPGNPGSGPGDPGSGPGNP` | Mixed GPGNP/GPGDP donor environment | LiCl V2 `1/27`, production `001`; NaCl V2 `2/27`, production `002-003` |
| 4 | **LiLC-1** | `GPGDPGSGNPGSGDP` | Lower-charge selectivity-control design | LiCl V2 `3/27`, production `003`; NaCl `V2 10/27`, production `010-011` |
...
| 7 | **LiN3-Core** | `GPGNPGPGNPGNP` | GPGNP trimer benchmark | LiCl V2 `3/27`, production `003`; NaCl `V2 10/27`, equilibration `010-011` |
| 8 | **LiA3-Ref** | `GPGAPGPGAPGPGAP` | Low-donor GPGAP reference | LiCl V2 `3/27`, production `003`; NaCl `V2 11/27`, production `011`, equilibration `012` |
