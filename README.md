...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-14 13:08 CST.** All 16 paired pulls are complete and all 480 windows exist. One hundred fifty-nine equilibrations are complete; 89 equilibrations plus 35 production windows use 124 real `mdrun` processes and 124/124 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-89_eq_%2B_35_prod-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-14 13:08 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 124 mdrun · 124 / 124 threads</code> <sub>89 equilibrations + 35 production</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 159 EQ done · 89 EQ + 35 production running</code></td>
      <td><img alt="paired window MD running" src="https://img.shields.io/badge/active-89_eq_%2B_35_prod-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~6.89 days</code></strong><br><sub>full-pool measured-rate schedule</sub></td>
      <td>All pulls are complete; 159 EQ are done and 35 production windows are active.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-21 ~14:25 CST</code></strong><br><sub>90% band 11:05–16:45 CST</sub></td>
