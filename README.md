...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-14 05:08 CST.** All 16 paired pulls are complete and all 480 windows exist. Forty-two equilibrations are complete; 121 equilibrations plus 3 production windows use 124 real `mdrun` processes and 124/124 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
> ![Campaigns running](https://img.shields.io/badge/active_work-121_eq_%2B_3_prod-38BDF8)
...
**Last synchronized monitor snapshot:** `2026-07-14 05:08 CST`
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>🔵 124 mdrun · 124 / 124 threads</code> <sub>121 equilibrations + 3 production</sub></td>
    ...
    <tr>
      ...
      <td><code>🔵 42 EQ done · 121 EQ + 3 production running</code></td>
      <td><img alt="paired window MD running" src="https://img.shields.io/badge/active-121_eq_%2B_3_prod-38BDF8"></td>
    </tr>
    <tr>
      <td>WHAM / PMF / ΔG</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>All pulls are complete; 42 EQ are done and 3 production windows are active.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><strong><code>2026-07-21 ~13:40 CST</code></strong><br><sub>90% band 08:50–17:20 CST</sub></td>
