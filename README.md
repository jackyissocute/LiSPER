...
> [!IMPORTANT]
> **Scientific steward snapshot: 2026-07-15 16:07 CST.** All 16 paired pulls are complete and all 480 windows exist. Three hundred thirty-one equilibrations and fifty production windows are complete; 20 equilibrations plus 106 production windows use 126 real `mdrun` processes and 126/126 computational threads. No current fatal, SETTLE, or LINCS error is present.
>
...
**Last synchronized monitor snapshot:** `2026-07-15 16:07 CST`
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><strong><code>~5.75 days</code></strong><br><sub>126-thread measured-rate schedule</sub></td>
      <td>All pulls are complete; 331 EQ and 50 production windows are done; 106 production windows are active.</td>
    </tr>
    <tr>
