...
- Summary TSV: `md/li_cl/remote_runs/equilibration_progress.tsv`
- Minimization summary: `md/li_cl/remote_runs/minimization_summary.tsv`
- Equilibration summary: `md/li_cl/remote_runs/equilibration_summary.tsv`
- Per-system outputs: `md/li_cl/remote_results/systems/<candidate>/gromacs/run_min/` and `run_eq/`
