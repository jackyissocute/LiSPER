...
Scientific steward snapshot: 2026-07-24 20:20 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 480 equilibrations complete; 467 production complete, 13 active |
| Real GROMACS work | 13 unique one-thread production `mdrun`; 13/126 umbrella-MD threads in 13 distinct directories, with all currently ready windows active |
...
| Measured horizon | Progress-adjusted queue = 0.10M atom·ns. The latest 443-minute tail progress basis is ≈5.45M atom·ns/day aggregate, giving median eight-row table ETA 2026-07-24 20:45 CST; ±20% throughput sensitivity gives 2026-07-24 20:41 to 2026-07-24 20:51 CST |
| Next | Keep all 13 tail windows running; launch paired WHAM immediately as each remaining candidate pair completes |

A five-second `/proc` sample found all 13 real GROMACS executables advancing, with 13 actual MD threads and no duplicate working directory. All currently ready windows are active. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. All 480 EQ windows and 467 production windows verified their configured final step plus `Finished mdrun`; 13 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Four paired rows are validated: LiDA-1 -19.340 ± 3.642, LiDS-1 -7.615 ± 7.286, LiD3-Core -3.630 ± 6.337, and LiD3-Flex -1.360 ± 10.003 kJ/mol. The patched off-host restart sync is advancing through restart checkpoints. No simulation repair is active. Tail throughput will continue to recalibrate the forecast.
...
|---|---|---:|---:|---:|---:|---:|---:|
| LiA3-Ref | LiCl | 30/30 | 0 | 0 | 27/30 | 3 | 3 |
| LiA3-Ref | NaCl | 30/30 | 0 | 0 | 26/30 | 4 | 4 |
...
| LiLC-1 | LiCl | 30/30 | 0 | 0 | 27/30 | 3 | 3 |
| LiLC-1 | NaCl | 30/30 | 0 | 0 | 30/30 | 0 | 0 |
| LiN3-Core | LiCl | 30/30 | 0 | 0 | 28/30 | 2 | 2 |
