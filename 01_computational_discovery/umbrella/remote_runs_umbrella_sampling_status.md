...
Last updated: 2026-06-28 23:05 CST
...
|---|---:|---:|---:|
| Worker A | 2 production threads | 12 V2 windows/pulls | 14/18 real `mdrun` active now |
| Worker B | 0 production threads | 7 V2 windows/pulls | 7/12 real `mdrun` active now |
