...
Last updated: 2026-07-08 02:11 CST
...
| `LiD3-Core` | LiCl | GCP | V2 `9/27` | production window `009`; equilibration `010` active | `🟩🟩🟩🟩🟩🟩🟩🟦⬜⬜` |
| `LiLC-1` | LiCl | GCP | V2 `2/27` | production window `002` active | `🟩🟩🟩🟦⬜⬜⬜⬜⬜⬜` |
| `LiN3-Core` | LiCl | GCP | V2 `2/27` | production window `002` active | `🟩🟩🟩🟦⬜⬜⬜⬜⬜⬜` |
| `LiA3-Ref` | LiCl | GCP | V2 `2/27` | production window `002` active | `🟩🟩🟩🟦⬜⬜⬜⬜⬜⬜` |
| `LiND-Hybrid` | LiCl | GCP | V2 `1/27` | equilibration window `001` active | `🟩🟩🟩🟦⬜⬜⬜⬜⬜⬜` |
