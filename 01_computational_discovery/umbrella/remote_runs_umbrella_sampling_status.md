...
Last updated: 2026-07-06 12:47 CST
...
| `LiD3-Core` | LiCl | GCP | V2 `6/27` | production windows `006-007` | `🟩🟩🟩🟩🟩🟩🟦⬜⬜⬜` |
| `LiLC-1` | LiCl | GCP | V2 `1/27` | window `001` active | `🟩🟩🟩🟦⬜⬜⬜⬜⬜⬜` |
