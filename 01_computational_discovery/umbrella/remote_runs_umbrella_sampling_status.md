...
Scientific steward snapshot: 2026-07-24 19:07 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 480 equilibrations complete; 457 production complete, 23 active |
| Real GROMACS work | 23 unique one-thread production `mdrun`; 23/126 umbrella-MD threads in 23 distinct directories, with all currently ready windows active |
...
| Measured horizon | Progress-adjusted queue = 0.23M atom·ns. The latest 370-minute tail progress basis is ≈6.01M atom·ns/day aggregate, giving median eight-row table ETA 2026-07-24 20:01 CST; ±20% throughput sensitivity gives 2026-07-24 19:52 to 2026-07-24 20:14 CST |
| Next | Keep all 23 tail windows running; launch paired WHAM immediately as each remaining candidate pair completes |

A five-second `/proc` sample found all 23 real GROMACS executables advancing, with 23 actual MD threads and no duplicate working directory. All currently ready windows are active. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. All 480 EQ windows and 457 production windows verified their configured final step plus `Finished mdrun`; 23 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. LiDS-1 and LiDA-1 remain the two validated rows at Delta Delta G = -7.615 ± 7.286 and -19.340 ± 3.642 kJ/mol, respectively. The patched off-host restart sync is advancing through restart checkpoints. No simulation repair is active. Tail throughput will continue to recalibrate the forecast.
...
| LiA3-Ref | NaCl | 30/30 | 0 | 0 | 24/30 | 6 | 6 |
| LiD3-Core | LiCl | 30/30 | 0 | 0 | 30/30 | 0 | 0 |
| LiD3-Core | NaCl | 30/30 | 0 | 0 | 29/30 | 1 | 1 |
