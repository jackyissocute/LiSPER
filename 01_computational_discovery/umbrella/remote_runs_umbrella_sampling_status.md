...
Scientific steward snapshot: 2026-07-22 18:57 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 440 equilibrations complete, 7 active; 242 production complete, 119 active |
...
| Reserved support | 0/2 threads in sustained use after the off-host restart sync completed; one support thread was used transiently for live verification and is now free |
...
| Measured horizon | Progress-adjusted queue = 17.48M atom·ns. The latest 180-minute same-host/protocol progress basis is ≈70,262 atom·ns/day/job (≈8.85M/day at 126 jobs), giving median table ETA 2026-07-24 18:21 CST; ±20% throughput sensitivity gives 2026-07-24 10:27 to 2026-07-25 06:12 CST |
...
A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. Four hundred forty EQ windows and two hundred forty-two production windows verified their configured final step plus `Finished mdrun`; 119 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. LiDA-1/NaCl remains at 30/30 production, but paired WHAM remains gated on LiDA-1/LiCl. The off-host restart sync completed successfully at 18:48 CST; simulation MD was unaffected. Production throughput will recalibrate the forecast.
...
|---|---|---:|---:|---:|---:|---:|---:|
| LiA3-Ref | LiCl | 25/30 | 5 | 0 | 10/30 | 20 | 8 |
| LiA3-Ref | NaCl | 20/30 | 10 | 0 | 8/30 | 22 | 2 |
| LiD3-Core | LiCl | 29/30 | 1 | 1 | 19/30 | 11 | 7 |
| LiD3-Core | NaCl | 27/30 | 3 | 0 | 10/30 | 20 | 5 |
| LiD3-Flex | LiCl | 30/30 | 0 | 0 | 17/30 | 13 | 11 |
| LiD3-Flex | NaCl | 30/30 | 0 | 0 | 11/30 | 19 | 19 |
| LiDA-1 | LiCl | 30/30 | 0 | 0 | 24/30 | 6 | 2 |
| LiDA-1 | NaCl | 30/30 | 0 | 0 | 30/30 | 0 | 0 |
| LiDS-1 | LiCl | 28/30 | 2 | 0 | 21/30 | 9 | 1 |
| LiDS-1 | NaCl | 27/30 | 3 | 0 | 20/30 | 10 | 3 |
| LiLC-1 | LiCl | 25/30 | 5 | 1 | 9/30 | 21 | 4 |
| LiLC-1 | NaCl | 25/30 | 5 | 2 | 8/30 | 22 | 9 |
| LiN3-Core | LiCl | 26/30 | 4 | 1 | 10/30 | 20 | 12 |
| LiN3-Core | NaCl | 29/30 | 1 | 1 | 15/30 | 15 | 9 |
| LiND-Hybrid | LiCl | 29/30 | 1 | 1 | 11/30 | 19 | 16 |
