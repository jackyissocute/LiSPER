...
Scientific steward snapshot: 2026-07-19 02:00 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 199 equilibrations complete, 93 active; 0 production complete, 33 active |
...
| Measured horizon | Progress-adjusted queue = 49.65M atom·ns. The latest one-hour same-host/protocol progress basis is ≈66,668 atom·ns/day/job (≈8.40M/day at 126 jobs), giving median table ETA 2026-07-24 23:51 CST; ±20% throughput sensitivity gives 2026-07-24 00:13 to 2026-07-26 11:19 CST |
...
A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. One hundred ninety-nine EQ windows verified their configured final step plus `Finished mdrun`, and 33 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Production throughput will recalibrate the forecast.
...
| LiD3-Flex | NaCl | 0/30 | 30 | 18 | 0/30 | 30 | 0 |
