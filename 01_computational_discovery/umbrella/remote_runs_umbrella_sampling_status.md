...
Scientific steward snapshot: 2026-07-21 12:41 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 402 equilibrations complete, 14 active; 140 production complete, 112 active |
| Real GROMACS work | 126 unique one-thread `mdrun`: 14 EQ windows + 112 production windows; 126/126 umbrella-MD threads in 126 distinct directories |
...
| Measured horizon | Progress-adjusted queue = 28.55M atom·ns. The latest 180-minute same-host/protocol progress basis is ≈68,864 atom·ns/day/job (≈8.68M/day at 126 jobs), giving median table ETA 2026-07-24 19:40 CST; ±20% throughput sensitivity gives 2026-07-24 06:30 to 2026-07-25 15:24 CST |
...
A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. Four hundred two EQ windows and one hundred forty production windows verified their configured final step plus `Finished mdrun`; 112 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. The off-host restart sync is active after multiple verified completions. Production throughput will recalibrate the forecast.
...
|---|---|---:|---:|---:|---:|---:|---:|
| LiA3-Ref | LiCl | 21/30 | 9 | 1 | 4/30 | 26 | 7 |
| LiA3-Ref | NaCl | 18/30 | 12 | 1 | 4/30 | 26 | 4 |
| LiD3-Core | LiCl | 25/30 | 5 | 2 | 14/30 | 16 | 5 |
| LiD3-Core | NaCl | 25/30 | 5 | 1 | 5/30 | 25 | 5 |
| LiD3-Flex | LiCl | 28/30 | 2 | 1 | 3/30 | 27 | 23 |
| LiD3-Flex | NaCl | 28/30 | 2 | 0 | 3/30 | 27 | 16 |
| LiDA-1 | LiCl | 30/30 | 0 | 0 | 20/30 | 10 | 0 |
| LiDA-1 | NaCl | 28/30 | 2 | 1 | 20/30 | 10 | 5 |
| LiDS-1 | LiCl | 27/30 | 3 | 0 | 12/30 | 18 | 7 |
| LiDS-1 | NaCl | 25/30 | 5 | 0 | 11/30 | 19 | 6 |
| LiLC-1 | LiCl | 20/30 | 10 | 3 | 7/30 | 23 | 2 |
| LiLC-1 | NaCl | 22/30 | 8 | 0 | 5/30 | 25 | 3 |
| LiN3-Core | LiCl | 25/30 | 5 | 1 | 4/30 | 26 | 6 |
| LiN3-Core | NaCl | 26/30 | 4 | 1 | 9/30 | 21 | 6 |
| LiND-Hybrid | LiCl | 25/30 | 5 | 1 | 8/30 | 22 | 4 |
| LiND-Hybrid | NaCl | 29/30 | 1 | 1 | 11/30 | 19 | 13 |
