...
Scientific steward snapshot: 2026-07-24 22:07 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 480 equilibrations complete; 477 production complete, 3 active |
...
| Measured horizon | Progress-adjusted queue = 0.028M atom·ns. The latest 31-minute three-job tail progress basis is ≈0.47M atom·ns/day aggregate, giving median eight-row table ETA 2026-07-24 23:31 CST; ±20% throughput sensitivity gives 2026-07-24 23:17 to 2026-07-24 23:52 CST |
| Next | Keep all 5 tail windows running; launch paired WHAM immediately as each remaining candidate pair completes |

A five-second `/proc` sample found all 3 real GROMACS executables advancing, with 3 actual MD threads and no duplicate working directory. All currently ready windows are active. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. All 480 EQ windows and 477 production windows verified their configured final step plus `Finished mdrun`; 3 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Five paired rows are protocol-validated: LiDA-1 -19.340 ± 3.642, LiDS-1 -7.615 ± 7.286, LiD3-Core -3.630 ± 6.337, LiD3-Flex -1.360 ± 10.003, and LiND-Hybrid -8.975 ± 9.825 kJ/mol. The uncertainty is retained explicitly and does not imply sign confidence when it spans zero. The patched off-host restart sync is advancing through restart checkpoints. No simulation repair is active. Tail throughput will continue to recalibrate the forecast.
