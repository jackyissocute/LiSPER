...
Scientific steward snapshot: 2026-07-18 18:04 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 93 equilibrations complete, 110 active; 0 production complete, 16 active |
...
| Measured horizon | Progress-adjusted queue = 52.56M atom·ns. The last verified same-host/protocol rate basis is ≈72,934 atom·ns/day/job (≈9.19M/day at 126 jobs), giving median table ETA 2026-07-24 15:20 CST; ±20% throughput sensitivity gives 2026-07-23 16:27 to 2026-07-26 01:38 CST |
| Next | Preserve the healthy 126/126 pool; give newly free slots first to the newly ready LiD3-Flex pair, then recalculate remaining atom-weighted campaign work |

A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. Ninety-three EQ windows verified their configured final step plus `Finished mdrun`, and 16 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Production throughput will recalibrate the forecast.
...
| LiD3-Flex | LiCl | 0/30 | 30 | 1 | 0/30 | 30 | 0 |
| LiD3-Flex | NaCl | 0/30 | 30 | 0 | 0/30 | 30 | 0 |
| LiDA-1 | LiCl | 30/30 | 0 | 0 | 0/30 | 30 | 11 |
| LiDA-1 | NaCl | 22/30 | 8 | 2 | 0/30 | 30 | 5 |
| LiDS-1 | LiCl | 23/30 | 7 | 2 | 0/30 | 30 | 0 |
| LiDS-1 | NaCl | 18/30 | 12 | 1 | 0/30 | 30 | 0 |
| LiLC-1 | LiCl | 0/30 | 30 | 16 | 0/30 | 30 | 0 |
| LiLC-1 | NaCl | 0/30 | 30 | 11 | 0/30 | 30 | 0 |
