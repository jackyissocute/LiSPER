...
Scientific steward snapshot: 2026-07-23 09:57 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 454 equilibrations complete, 6 active; 292 production complete, 120 active |
...
| Measured horizon | Progress-adjusted queue = 11.91M atom·ns. The latest 174-minute same-host/protocol progress basis is ≈71,014 atom·ns/day/job (≈8.95M/day at 126 jobs), giving median table ETA 2026-07-24 17:53 CST; ±20% throughput sensitivity gives 2026-07-24 12:34 to 2026-07-25 01:52 CST |
...
A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. Four hundred fifty-four EQ windows and two hundred ninety-two production windows verified their configured final step plus `Finished mdrun`; 120 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. LiDA-1/NaCl remains at 30/30 production, but paired WHAM remains gated on the healthy, advancing LiDA-1/LiCl window at 26/30. The off-host restart sync is active; simulation MD is unaffected. Production throughput will recalibrate the forecast.
...
|---|---|---:|---:|---:|---:|---:|---:|
| LiA3-Ref | LiCl | 27/30 | 3 | 1 | 15/30 | 15 | 9 |
| LiA3-Ref | NaCl | 22/30 | 8 | 1 | 9/30 | 21 | 5 |
| LiD3-Core | LiCl | 30/30 | 0 | 0 | 23/30 | 7 | 4 |
| LiD3-Core | NaCl | 27/30 | 3 | 0 | 12/30 | 18 | 11 |
...
| LiDS-1 | LiCl | 29/30 | 1 | 0 | 21/30 | 9 | 3 |
| LiDS-1 | NaCl | 28/30 | 2 | 0 | 22/30 | 8 | 4 |
| LiLC-1 | LiCl | 26/30 | 4 | 1 | 11/30 | 19 | 9 |
| LiLC-1 | NaCl | 28/30 | 2 | 2 | 8/30 | 22 | 16 |
| LiN3-Core | LiCl | 27/30 | 3 | 1 | 14/30 | 16 | 10 |
| LiN3-Core | NaCl | 30/30 | 0 | 0 | 19/30 | 11 | 10 |
| LiND-Hybrid | LiCl | 30/30 | 0 | 0 | 13/30 | 17 | 17 |
| LiND-Hybrid | NaCl | 30/30 | 0 | 0 | 24/30 | 6 | 6 |
