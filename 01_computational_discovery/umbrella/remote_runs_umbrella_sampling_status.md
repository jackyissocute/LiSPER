...
Scientific steward snapshot: 2026-07-19 05:00 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 208 equilibrations complete, 93 active; 3 production complete, 33 active |
| Real GROMACS work | 126 unique one-thread `mdrun`: 93 EQ windows + 33 production windows; 126/126 umbrella-MD threads in 126 distinct directories |
...
| Measured horizon | Progress-adjusted queue = 48.56M atom·ns. The latest one-hour same-host/protocol progress basis is ≈70,305 atom·ns/day/job (≈8.86M/day at 126 jobs), giving median table ETA 2026-07-24 16:33 CST; ±20% throughput sensitivity gives 2026-07-23 18:38 to 2026-07-26 01:27 CST |
...
A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. Two hundred eight EQ windows and three production windows verified their configured final step plus `Finished mdrun`; 33 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Production throughput will recalibrate the forecast.
...
|---|---|---:|---:|---:|---:|---:|---:|
| LiA3-Ref | LiCl | 6/30 | 24 | 4 | 0/30 | 30 | 0 |
| LiA3-Ref | NaCl | 8/30 | 22 | 1 | 0/30 | 30 | 0 |
| LiD3-Core | LiCl | 17/30 | 13 | 2 | 0/30 | 30 | 2 |
| LiD3-Core | NaCl | 15/30 | 15 | 4 | 0/30 | 30 | 2 |
| LiD3-Flex | LiCl | 0/30 | 30 | 18 | 0/30 | 30 | 0 |
| LiD3-Flex | NaCl | 0/30 | 30 | 20 | 0/30 | 30 | 0 |
| LiDA-1 | LiCl | 30/30 | 0 | 0 | 3/30 | 27 | 10 |
| LiDA-1 | NaCl | 27/30 | 3 | 0 | 0/30 | 30 | 10 |
| LiDS-1 | LiCl | 25/30 | 5 | 0 | 0/30 | 30 | 1 |
| LiDS-1 | NaCl | 21/30 | 9 | 0 | 0/30 | 30 | 1 |
| LiLC-1 | LiCl | 16/30 | 14 | 0 | 0/30 | 30 | 1 |
| LiLC-1 | NaCl | 12/30 | 18 | 0 | 0/30 | 30 | 1 |
| LiN3-Core | LiCl | 8/30 | 22 | 8 | 0/30 | 30 | 1 |
| LiN3-Core | NaCl | 8/30 | 22 | 5 | 0/30 | 30 | 2 |
| LiND-Hybrid | LiCl | 4/30 | 26 | 16 | 0/30 | 30 | 1 |
| LiND-Hybrid | NaCl | 11/30 | 19 | 15 | 0/30 | 30 | 1 |
