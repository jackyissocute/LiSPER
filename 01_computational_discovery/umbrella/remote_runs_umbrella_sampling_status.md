...
Scientific steward snapshot: 2026-07-19 09:17 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 261 equilibrations complete, 76 active; 16 production complete, 50 active |
| Real GROMACS work | 126 unique one-thread `mdrun`: 76 EQ windows + 50 production windows; 126/126 umbrella-MD threads in 126 distinct directories |
...
| Measured horizon | Progress-adjusted queue = 46.98M atom·ns. The latest 62-minute same-host/protocol progress basis is ≈72,500 atom·ns/day/job (≈9.13M/day at 126 jobs), giving median table ETA 2026-07-24 12:42 CST; ±20% throughput sensitivity gives 2026-07-23 16:08 to 2026-07-25 19:33 CST |
...
A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. Two hundred sixty-one EQ windows and sixteen production windows verified their configured final step plus `Finished mdrun`; 50 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Production throughput will recalibrate the forecast.
...
|---|---|---:|---:|---:|---:|---:|---:|
| LiA3-Ref | LiCl | 9/30 | 21 | 2 | 0/30 | 30 | 0 |
| LiA3-Ref | NaCl | 9/30 | 21 | 4 | 0/30 | 30 | 2 |
| LiD3-Core | LiCl | 18/30 | 12 | 3 | 0/30 | 30 | 4 |
| LiD3-Core | NaCl | 19/30 | 11 | 1 | 0/30 | 30 | 3 |
| LiD3-Flex | LiCl | 7/30 | 23 | 18 | 0/30 | 30 | 2 |
| LiD3-Flex | NaCl | 8/30 | 22 | 17 | 0/30 | 30 | 1 |
...
| LiN3-Core | NaCl | 12/30 | 18 | 3 | 0/30 | 30 | 3 |
| LiND-Hybrid | LiCl | 14/30 | 16 | 8 | 0/30 | 30 | 4 |
