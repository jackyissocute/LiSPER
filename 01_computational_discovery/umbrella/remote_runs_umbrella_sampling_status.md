...
Scientific steward snapshot: 2026-07-21 00:40 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 389 equilibrations complete, 10 active; 94 production complete, 116 active |
...
| Measured horizon | Progress-adjusted queue = 32.90M atom·ns. The latest 180-minute same-host/protocol progress basis is ≈68,204 atom·ns/day/job (≈8.59M/day at 126 jobs), giving median table ETA 2026-07-24 20:33 CST; ±20% throughput sensitivity gives 2026-07-24 05:15 to 2026-07-25 19:31 CST |
...
A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. Three hundred eighty-nine EQ windows and ninety-four production windows verified their configured final step plus `Finished mdrun`; 116 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Production throughput will recalibrate the forecast.
...
| LiN3-Core | NaCl | 24/30 | 6 | 1 | 5/30 | 25 | 6 |
| LiND-Hybrid | LiCl | 24/30 | 6 | 1 | 1/30 | 29 | 11 |
