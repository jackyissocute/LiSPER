...
Last updated: 2026-07-13 01:10 CST
...
| Stage | Pull complete; window eq ~91% (≈455 ps / 500 ps; 30 windows/ion; 0 failed) |
...
|---|---|---|---|
| `LiLC-1` | preferred pilot | terminal Asp14 | **VALIDATED_BOUND** — window eq ~91% |
