...
Scientific steward snapshot: 2026-07-19 06:00 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 213 equilibrations complete, 92 active; 4 production complete, 34 active |
| Real GROMACS work | 126 unique one-thread `mdrun`: 92 EQ windows + 34 production windows; 126/126 umbrella-MD threads in 126 distinct directories |
...
| Measured horizon | Progress-adjusted queue = 48.19M atom·ns. The latest one-hour same-host/protocol progress basis is ≈70,821 atom·ns/day/job (≈8.92M/day at 126 jobs), giving median table ETA 2026-07-24 15:36 CST; ±20% throughput sensitivity gives 2026-07-23 18:00 to 2026-07-26 00:00 CST |
...
A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. Two hundred thirteen EQ windows and four production windows verified their configured final step plus `Finished mdrun`; 34 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Production throughput will recalibrate the forecast.
...
| LiN3-Core | LiCl | 9/30 | 21 | 8 | 0/30 | 30 | 1 |
| LiN3-Core | NaCl | 10/30 | 20 | 3 | 0/30 | 30 | 2 |
