...
Scientific steward snapshot: 2026-07-18 22:00 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 141 equilibrations complete, 106 active; 0 production complete, 20 active |
| Real GROMACS work | 126 unique one-thread `mdrun`: 106 EQ windows + 20 production windows; 126/126 umbrella-MD threads in 126 distinct directories |
...
| Measured horizon | Progress-adjusted queue = 51.13M atom·ns. The last verified same-host/protocol rate basis is ≈72,934 atom·ns/day/job (≈9.19M/day at 126 jobs), giving median table ETA 2026-07-24 15:32 CST; ±20% throughput sensitivity gives 2026-07-23 17:16 to 2026-07-26 00:55 CST |
...
A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. One hundred forty-one EQ windows verified their configured final step plus `Finished mdrun`, and 20 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Production throughput will recalibrate the forecast.
...
|---|---|---:|---:|---:|---:|---:|---:|
| LiA3-Ref | LiCl | 3/30 | 27 | 3 | 0/30 | 30 | 0 |
| LiA3-Ref | NaCl | 3/30 | 27 | 5 | 0/30 | 30 | 0 |
| LiD3-Core | LiCl | 6/30 | 24 | 12 | 0/30 | 30 | 0 |
| LiD3-Core | NaCl | 7/30 | 23 | 8 | 0/30 | 30 | 0 |
| LiD3-Flex | LiCl | 0/30 | 30 | 9 | 0/30 | 30 | 0 |
...
| LiLC-1 | NaCl | 4/30 | 26 | 8 | 0/30 | 30 | 0 |
| LiN3-Core | LiCl | 2/30 | 28 | 7 | 0/30 | 30 | 0 |
| LiN3-Core | NaCl | 4/30 | 26 | 5 | 0/30 | 30 | 0 |
| LiND-Hybrid | LiCl | 0/30 | 30 | 14 | 0/30 | 30 | 0 |
