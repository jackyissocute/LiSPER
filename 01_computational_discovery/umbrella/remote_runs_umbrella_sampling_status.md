...
Last updated: 2026-07-09 13:24 CST
...
| `LiD3-Flex` | LiCl | GCP | V2 `20/27` | production window `014`; equilibration windows `016-018` active | `🟩🟩🟩🟩🟩🟩🟩🟦⬜⬜` |
| `LiD3-Core` | LiCl | GCP | V2 `11/27` | production window `011`; equilibration window `012` active | `🟩🟩🟩🟩🟩🟩🟩🟦⬜⬜` |
...
| `LiLC-1` | NaCl | GCP | V2 `11/27` | production window `011`; equilibration window `012` active | `🟩🟩🟩🟩🟩🟩🟩🟦⬜⬜` |
| `LiA3-Ref` | NaCl | GCP | V2 `12/27` | equilibration windows `012-013` active | `🟩🟩🟩🟩🟩🟩🟩🟦⬜⬜` |
| `LiD3-Core` | NaCl | GCP | V2 `11/27` | production window `011`; equilibration window `012` active | `🟩🟩🟩🟩🟩🟩🟩🟦⬜⬜` |
