...
Scientific steward snapshot: 2026-07-18 14:59 CST
...
| Stage | 14/16 pulls complete, 2 active; 420/480 windows generated; 42 equilibrations complete, 109 active; 0 production complete, 3 active |
| Real GROMACS work | 114 unique `mdrun`: 2 seven-thread pulls + 109 one-thread EQ windows + 3 one-thread production windows; 126/126 umbrella-MD threads in 114 distinct directories |
...
| Measured horizon | Progress-adjusted queue = 53.64M atom·ns. The last verified same-host/protocol rate basis is ≈72,934 atom·ns/day/job (≈9.19M/day at 126 jobs), giving median table ETA 2026-07-24 15:05 CST; ±20% throughput sensitivity gives 2026-07-23 15:45 to 2026-07-26 02:05 CST |
...
A five-second `/proc` sample found all 114 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. Fourteen pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. Forty-two LiDA-1 EQ windows verified their configured final step plus `Finished mdrun`, and three LiDA-1/LiCl production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Production throughput will recalibrate the forecast.
...
|---|---|---:|---:|---:|---:|---:|---:|
| LiA3-Ref | LiCl | 0/30 | 30 | 4 | 0/30 | 30 | 0 |
| LiA3-Ref | NaCl | 0/30 | 30 | 5 | 0/30 | 30 | 0 |
| LiD3-Core | LiCl | 0/30 | 30 | 6 | 0/30 | 30 | 0 |
| LiD3-Core | NaCl | 0/30 | 30 | 8 | 0/30 | 30 | 0 |
| LiD3-Flex | LiCl | 0/30 | 30 | 0 | 0/30 | 30 | 0 |
| LiD3-Flex | NaCl | 0/30 | 30 | 0 | 0/30 | 30 | 0 |
| LiDA-1 | LiCl | 30/30 | 0 | 0 | 0/30 | 30 | 3 |
| LiDA-1 | NaCl | 12/30 | 18 | 10 | 0/30 | 30 | 0 |
| LiDS-1 | LiCl | 0/30 | 30 | 24 | 0/30 | 30 | 0 |
| LiDS-1 | NaCl | 0/30 | 30 | 19 | 0/30 | 30 | 0 |
| LiLC-1 | LiCl | 0/30 | 30 | 14 | 0/30 | 30 | 0 |
| LiLC-1 | NaCl | 0/30 | 30 | 5 | 0/30 | 30 | 0 |
| LiN3-Core | LiCl | 0/30 | 30 | 3 | 0/30 | 30 | 0 |
| LiN3-Core | NaCl | 0/30 | 30 | 4 | 0/30 | 30 | 0 |
| LiND-Hybrid | LiCl | 0/30 | 30 | 3 | 0/30 | 30 | 0 |
