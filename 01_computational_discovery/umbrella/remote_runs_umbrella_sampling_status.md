...
Scientific steward snapshot: 2026-07-18 12:13 CST
...
| Stage | 12/16 pulls complete, 4 active; 360/480 windows generated; 0 equilibrations complete, 98 active; 0 production complete |
| Real GROMACS work | 102 unique `mdrun`: 4 seven-thread pulls + 98 one-thread EQ windows; 126/126 umbrella-MD threads in 102 distinct directories |
...
| Measured horizon | Progress-adjusted queue = 54.60M atom·ns. The last verified same-host/protocol rate basis is ≈72,934 atom·ns/day/job (≈9.19M/day at 126 jobs), giving nominal table ETA 2026-07-24 14:50 CST; ±20% throughput sensitivity gives 2026-07-23 15:05 to 2026-07-26 02:30 CST |
...
A five-second `/proc` sample found all 102 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. Twelve pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. The 98 one-thread EQ slots span LiDA-1, LiDS-1, LiLC-1, and LiN3-Core; newly freed capacity is flowing to ready higher-atom-count work without interrupting healthy jobs. No active log contains a fatal, water-SETTLE, or LINCS warning. New one-thread EQ/production evidence will recalibrate the forecast.
...
| LiDA-1 | NaCl | 0/30 | 30 | 20 | 0/30 | 30 | 0 |
| LiDS-1 | LiCl | 0/30 | 30 | 19 | 0/30 | 30 | 0 |
| LiDS-1 | NaCl | 0/30 | 30 | 17 | 0/30 | 30 | 0 |
| LiLC-1 | LiCl | 0/30 | 30 | 10 | 0/30 | 30 | 0 |
| LiLC-1 | NaCl | 0/30 | 30 | 0 | 0/30 | 30 | 0 |
| LiN3-Core | LiCl | 0/30 | 30 | 0 | 0/30 | 30 | 0 |
| LiN3-Core | NaCl | 0/30 | 30 | 2 | 0/30 | 30 | 0 |
