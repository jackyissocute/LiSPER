...
Scientific steward snapshot: 2026-07-19 08:15 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 236 equilibrations complete, 89 active; 16 production complete, 37 active |
| Real GROMACS work | 126 unique one-thread `mdrun`: 89 EQ windows + 37 production windows; 126/126 umbrella-MD threads in 126 distinct directories |
...
| Measured horizon | Progress-adjusted queue = 47.37M atom·ns. The latest 75-minute same-host/protocol progress basis is ≈67,886 atom·ns/day/job (≈8.55M/day at 126 jobs), giving median table ETA 2026-07-24 21:09 CST; ±20% throughput sensitivity gives 2026-07-23 23:00 to 2026-07-26 06:23 CST |
...
A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. Two hundred thirty-six EQ windows and sixteen production windows verified their configured final step plus `Finished mdrun`; 37 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Production throughput will recalibrate the forecast.
...
| LiD3-Core | LiCl | 18/30 | 12 | 3 | 0/30 | 30 | 4 |
| LiD3-Core | NaCl | 16/30 | 14 | 3 | 0/30 | 30 | 3 |
| LiD3-Flex | LiCl | 4/30 | 26 | 19 | 0/30 | 30 | 1 |
| LiD3-Flex | NaCl | 7/30 | 23 | 16 | 0/30 | 30 | 0 |
| LiDA-1 | LiCl | 30/30 | 0 | 0 | 11/30 | 19 | 2 |
| LiDA-1 | NaCl | 27/30 | 3 | 0 | 5/30 | 25 | 7 |
| LiDS-1 | LiCl | 25/30 | 5 | 0 | 0/30 | 30 | 2 |
| LiDS-1 | NaCl | 21/30 | 9 | 0 | 0/30 | 30 | 1 |
| LiLC-1 | LiCl | 16/30 | 14 | 1 | 0/30 | 30 | 2 |
| LiLC-1 | NaCl | 12/30 | 18 | 5 | 0/30 | 30 | 3 |
| LiN3-Core | LiCl | 10/30 | 20 | 7 | 0/30 | 30 | 2 |
| LiN3-Core | NaCl | 11/30 | 19 | 4 | 0/30 | 30 | 3 |
| LiND-Hybrid | LiCl | 9/30 | 21 | 12 | 0/30 | 30 | 1 |
| LiND-Hybrid | NaCl | 14/30 | 16 | 13 | 0/30 | 30 | 5 |
