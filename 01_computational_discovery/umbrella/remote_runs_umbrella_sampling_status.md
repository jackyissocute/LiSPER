...
Scientific steward snapshot: 2026-07-19 04:00 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 202 equilibrations complete, 94 active; 1 production complete, 32 active |
| Real GROMACS work | 126 unique one-thread `mdrun`: 94 EQ windows + 32 production windows; 126/126 umbrella-MD threads in 126 distinct directories |
...
| Measured horizon | Progress-adjusted queue = 48.93M atom·ns. The latest two-hour same-host/protocol progress basis is ≈68,815 atom·ns/day/job (≈8.67M/day at 126 jobs), giving median table ETA 2026-07-24 19:26 CST; ±20% throughput sensitivity gives 2026-07-23 20:51 to 2026-07-26 05:17 CST |
...
A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. Two hundred two EQ windows and one production window verified their configured final step plus `Finished mdrun`; 32 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Production throughput will recalibrate the forecast.
...
| LiD3-Core | LiCl | 17/30 | 13 | 1 | 0/30 | 30 | 1 |
| LiD3-Core | NaCl | 15/30 | 15 | 4 | 0/30 | 30 | 2 |
| LiD3-Flex | LiCl | 0/30 | 30 | 16 | 0/30 | 30 | 0 |
| LiD3-Flex | NaCl | 0/30 | 30 | 20 | 0/30 | 30 | 0 |
| LiDA-1 | LiCl | 30/30 | 0 | 0 | 1/30 | 29 | 11 |
...
| LiN3-Core | NaCl | 8/30 | 22 | 4 | 0/30 | 30 | 2 |
| LiND-Hybrid | LiCl | 3/30 | 27 | 16 | 0/30 | 30 | 0 |
| LiND-Hybrid | NaCl | 6/30 | 24 | 20 | 0/30 | 30 | 1 |
