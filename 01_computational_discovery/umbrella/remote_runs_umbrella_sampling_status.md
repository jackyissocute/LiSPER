...
Last updated: 2026-07-06 08:43 CST
...
| `LiLC-1` | LiCl | GCP | V2 `2/27` | window `001` active | `🟩🟩🟩🟦⬜⬜⬜⬜⬜⬜` |
| `LiN3-Core` | LiCl | GCP | V2 `2/27` | window `001` active | `🟩🟩🟩🟦⬜⬜⬜⬜⬜⬜` |
| `LiA3-Ref` | LiCl | GCP | V2 `2/27` | window `001` active | `🟩🟩🟩🟦⬜⬜⬜⬜⬜⬜` |
| `LiND-Hybrid` | LiCl | GCP | V2 `1/27` | window `000` active | `🟩🟩🟩🟦⬜⬜⬜⬜⬜⬜` |
