...
Scientific steward snapshot: 2026-07-19 20:39 CST
...
| Stage | 16/16 pulls complete; 480/480 windows generated; 342 equilibrations complete, 23 active; 26 production complete, 103 active |
| Real GROMACS work | 126 unique one-thread `mdrun`: 23 EQ windows + 103 production windows; 126/126 umbrella-MD threads in 126 distinct directories |
...
| Measured horizon | Progress-adjusted queue = 42.90M atom·ns. The latest 180-minute same-host/protocol progress basis is ≈68,217 atom·ns/day/job (≈8.60M/day at 126 jobs), giving median table ETA 2026-07-24 20:26 CST; ±20% throughput sensitivity gives 2026-07-24 00:28 to 2026-07-26 02:23 CST |
...
A five-second `/proc` sample found all 126 real GROMACS executables advancing, with 126 actual MD threads and no duplicate working directory. All 16 pulls independently verified configured step 500,000 plus `Finished mdrun`; each generated 30 windows. Three hundred forty-two EQ windows and twenty-six production windows verified their configured final step plus `Finished mdrun`; 103 production windows are active. No active log contains a fatal, water-SETTLE, or LINCS warning. Production throughput will recalibrate the forecast.
...
|---|---|---:|---:|---:|---:|---:|---:|
| LiA3-Ref | LiCl | 12/30 | 18 | 1 | 0/30 | 30 | 3 |
| LiA3-Ref | NaCl | 13/30 | 17 | 3 | 0/30 | 30 | 3 |
| LiD3-Core | LiCl | 23/30 | 7 | 1 | 0/30 | 30 | 11 |
| LiD3-Core | NaCl | 20/30 | 10 | 2 | 0/30 | 30 | 5 |
| LiD3-Flex | LiCl | 23/30 | 7 | 3 | 0/30 | 30 | 9 |
| LiD3-Flex | NaCl | 23/30 | 7 | 4 | 0/30 | 30 | 7 |
| LiDA-1 | LiCl | 30/30 | 0 | 0 | 13/30 | 17 | 2 |
| LiDA-1 | NaCl | 27/30 | 3 | 0 | 11/30 | 19 | 8 |
| LiDS-1 | LiCl | 26/30 | 4 | 0 | 1/30 | 29 | 6 |
| LiDS-1 | NaCl | 25/30 | 5 | 0 | 1/30 | 29 | 6 |
| LiLC-1 | LiCl | 17/30 | 13 | 2 | 0/30 | 30 | 5 |
| LiLC-1 | NaCl | 18/30 | 12 | 2 | 0/30 | 30 | 5 |
| LiN3-Core | LiCl | 17/30 | 13 | 2 | 0/30 | 30 | 3 |
| LiN3-Core | NaCl | 17/30 | 13 | 2 | 0/30 | 30 | 8 |
| LiND-Hybrid | LiCl | 23/30 | 7 | 1 | 0/30 | 30 | 9 |
| LiND-Hybrid | NaCl | 28/30 | 2 | 0 | 0/30 | 30 | 13 |
