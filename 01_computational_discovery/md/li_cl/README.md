...
| 20 ns production | 8/8 active; `3.75-12.91 ns / 20 ns` as of `2026-06-19 23:24 CST` |
...
|---|---|
| `LiD3-Core` | `5.70 ns / 20 ns`; clustering queued |
| `LiD3-Flex` | `3.80 ns / 20 ns`; clustering queued |
| `LiND-Hybrid` | `3.75 ns / 20 ns`; clustering queued |
| `LiLC-1` | `5.83 ns / 20 ns`; clustering queued |
| `LiDS-1` | `8.84 ns / 20 ns`; clustering queued |
| `LiDA-1` | `12.91 ns / 20 ns`; clustering queued |
| `LiN3-Core` | `5.86 ns / 20 ns`; clustering queued |
| `LiA3-Ref` | `5.71 ns / 20 ns`; clustering queued |
