...
| 20 ns production | 8/8 active; `2.60-8.97 ns / 20 ns` as of `2026-06-19 14:24 CST` |
...
|---|---|
| `LiD3-Core` | `3.96 ns / 20 ns`; clustering queued |
| `LiD3-Flex` | `2.65 ns / 20 ns`; clustering queued |
| `LiND-Hybrid` | `2.60 ns / 20 ns`; clustering queued |
| `LiLC-1` | `4.05 ns / 20 ns`; clustering queued |
| `LiDS-1` | `6.14 ns / 20 ns`; clustering queued |
| `LiDA-1` | `8.97 ns / 20 ns`; clustering queued |
| `LiN3-Core` | `4.08 ns / 20 ns`; clustering queued |
| `LiA3-Ref` | `3.97 ns / 20 ns`; clustering queued |
