...
| 20 ns production | 7/8 active; `6.14-14.48 ns / 20 ns` as of `2026-06-20 17:29 CST`; `LiDA-1` complete |
...
|---|---|
| `LiD3-Core` | `9.34 ns / 20 ns`; clustering queued |
| `LiD3-Flex` | `6.16 ns / 20 ns`; clustering queued |
| `LiND-Hybrid` | `6.14 ns / 20 ns`; clustering queued |
| `LiLC-1` | `9.44 ns / 20 ns`; clustering queued |
| `LiDS-1` | `14.48 ns / 20 ns`; clustering queued |
| `LiDA-1` | `20.00 ns / 20 ns`; representative ready; top cluster `17.64%` |
| `LiN3-Core` | `9.50 ns / 20 ns`; clustering queued |
| `LiA3-Ref` | `9.26 ns / 20 ns`; clustering queued |
