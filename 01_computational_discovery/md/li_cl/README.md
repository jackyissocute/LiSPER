...
| 20 ns production | 6/8 active; `11.06-17.13 ns / 20 ns` as of `2026-06-22 09:10 CST`; `LiDA-1` and `LiDS-1` complete |
| Structural clustering | 2/8 complete; `LiDA-1` top cluster `17.64%`; `LiDS-1` top cluster `15.69%`; others queued after production |
| PMF handoff | Umbrella windows active: `LiDA-1` `3/19`, active `003`; `LiDS-1` `2/21`, active `002` |
...
| `LiDA-1` | `20.00 ns / 20 ns`; representative ready; top cluster `17.64%`; umbrella `3/19`, active `003` |
