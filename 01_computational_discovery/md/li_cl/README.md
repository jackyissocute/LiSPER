...
| 20 ns production | 7/8 active; `6.94-16.38 ns / 20 ns` as of `2026-06-20 23:41 CST`; `LiDA-1` complete |
...
|---|---|
| `LiD3-Core` | `10.56 ns / 20 ns`; clustering queued |
| `LiD3-Flex` | `6.97 ns / 20 ns`; clustering queued |
| `LiND-Hybrid` | `6.94 ns / 20 ns`; clustering queued |
| `LiLC-1` | `10.67 ns / 20 ns`; clustering queued |
| `LiDS-1` | `16.38 ns / 20 ns`; clustering queued |
| `LiDA-1` | `20.00 ns / 20 ns`; representative ready; top cluster `17.64%` |
| `LiN3-Core` | `10.73 ns / 20 ns`; clustering queued |
| `LiA3-Ref` | `10.46 ns / 20 ns`; clustering queued |
