...
Synced from remote logs on 2026-06-15 10:20 CST.
...
| IDP-Li-1 | production_20ns | running | 4325000 | 8650.00000 | 43.25% | 2.94620e+02 | 7.57765e+00 | 2.32274e-06 | false |
...
- The queue has moved on to `IDP-Li-1`, which is currently running 20 ns LiCl production. Its latest synced production state is 8.65 ns / 20 ns, temperature near 295 K, small constraint RMSD, and no fatal markers.
...
The active `IDP-Li-1` production run has reached 4.325 million of 10 million steps after about 5.5 hours of `gmx mdrun` wall time.

| Scope | Estimate |
|---|---:|
| `IDP-Li-1` production remaining | about 7-8 hours if the current rate holds |
