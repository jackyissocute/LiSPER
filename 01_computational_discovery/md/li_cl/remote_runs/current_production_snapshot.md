...
Synced from remote logs on 2026-06-14 15:08 CST.

| Candidate | Stage | Status | Last step | Time ps | Progress | T K | P bar | Constraint RMSD | Fatal markers |
|---|---|---|---:|---:|---:|---:|---:|---:|---|
| LiD3-1 | production_20ns | running | 4500000 | 9000.00000 | 45.00% | 2.97039e+02 | 1.50208e+01 | 2.39933e-06 | false |

## QC Interpretation

- Active remote job: `LiD3-1` LiCl 20 ns production MD.
- Current progress: 9.00 ns of 20 ns complete.
...
The active `LiD3-1` production run has reached 4.500 million of 10 million steps after about 11.3 hours of `gmx mdrun` wall time.

| Scope | Estimate |
|---|---:|
| `LiD3-1` production remaining | about 14 hours |
