...
|---|---|---|
| LiCl | `li_cl/` | 10/10 equilibrated; 3 productions complete; `LiND-1` running at 1.55 ns / 20 ns; 3 repaired representatives ready |
| NaCl | `na_cl/` | 10/10 minimized/equilibrated; production/clustering queued behind LiCl |

Latest monitor snapshot: `2026-06-16 15:29 CST`.
