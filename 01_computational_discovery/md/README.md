...
Latest production/umbrella snapshot: `2026-06-25 14:25 CST`.

| Condition | Folder | Current state |
|---|---|---|
| LiCl | `li_cl/` | Replacement Worker A active at 8/18 safe mdrun threads after stopping old non-v2 windows; 2/8 production jobs active plus audited v2 `LiDS-1` and `LiDA-1` LiCl pulls; 6/8 representatives ready |
