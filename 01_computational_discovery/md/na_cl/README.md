...
| 20 ns production | Worker B active at `12/12` cores with 4 checkpoint-resumed jobs at `10.11-15.99 ns / 20 ns`; replacement Worker A backfill active at `3.49-5.27 ns / 20 ns` as of `2026-06-22 22:12 CST`; `LiDA-1` and `LiDS-1` complete |
