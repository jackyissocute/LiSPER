...
| PMF handoff | Umbrella windows: `LiDA-1` `15/15` complete plus repair extensions `5/5` complete, combined WHAM/bootstrap QC complete but still preliminary; `LiDS-1` `17/17` complete with preliminary WHAM/QC complete; `LiLC-1` `4/21` complete with windows `004-005` active; `LiA3-Ref` and `LiD3-Core` `4/21` complete with windows `004-007` active |
...
| `LiDS-1` | `20.00 ns / 20 ns`; representative ready; top cluster `14.59%`; umbrella `17/17` complete; preliminary WHAM/QC complete with empty/weak-bin warnings |
