...
|---|---|
| `LiD3-Core` | Recovered checkpoint resume on Worker B; `17.02 ns / 20 ns`; clustering queued |
| `LiD3-Flex` | Recovered checkpoint resume on Worker B; `11.42 ns / 20 ns`; clustering queued |
| `LiND-Hybrid` | Replacement Worker A backfill active; `3.97 ns / 20 ns`; clustering queued |
| `LiLC-1` | Recovered checkpoint resume on Worker B; `17.82 ns / 20 ns`; clustering queued |
...
| `LiN3-Core` | Replacement Worker A backfill active; `6.02 ns / 20 ns`; clustering queued |
| `LiA3-Ref` | Recovered checkpoint resume on Worker B; `16.50 ns / 20 ns`; clustering queued |
