...
| PMF handoff | Umbrella windows: `LiDA-1` `15/15` complete plus repair extensions `5/5` complete, combined WHAM/bootstrap QC queued; `LiDS-1` `17/17` complete and ready for preliminary WHAM/QC; `LiLC-1` windows `002-003` active; `LiA3-Ref` and repaired `LiD3-Core` windows `000-003` active |
...
| `LiDA-1` | `20.00 ns / 20 ns`; representative ready; top cluster `17.94%`; umbrella `15/15` complete; repair extensions `5/5` complete; combined WHAM/bootstrap QC queued |
