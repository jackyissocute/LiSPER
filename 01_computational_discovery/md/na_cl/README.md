...
| Free-energy handoff | Representatives are handed to `../../umbrella/`; old/default windows and repair extensions are diagnostics only. Audited v2 NaCl window equilibration is active for both `LiDS-1` and `LiDA-1`; final PMF/Delta G waits in `../../pmf/` for v2 WHAM/bootstrap/time-slice QC |
