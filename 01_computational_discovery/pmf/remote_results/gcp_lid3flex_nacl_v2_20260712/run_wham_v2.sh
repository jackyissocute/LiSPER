...
gmx wham -it tpr-files.dat -if pullf-files.dat -o profile_v2_b250.xvg -hist histo_v2_b250.xvg -unit kJ -b 250 2>&1 | tee wham_v2_b250.log
gmx wham -it tpr-files.dat -if pullf-files.dat -o profile_v2_b500.xvg -hist histo_v2_b500.xvg -unit kJ -b 500 2>&1 | tee wham_v2_b500.log
mkdir -p bootstrap_100_b100
# bootstrap already completed: gmx wham -it tpr-files.dat -if pullf-files.dat -o bootstrap_100_b100/profile_kjmol.xvg -hist bootstrap_100_b100/histo.xvg -unit kJ -b 100 -nBootstrap 100 -bsres bootstrap_100_b100/bootstrap_profiles.xvg -bsprof bootstrap_100_b100/bootstrap_profile_std.xvg 2>&1 | tee bootstrap_100_b100/wham.stdout.log
python3 - <<'PY'
...
logs=[]
for p in ["wham_v2.log","wham_v2_b250.log","wham_v2_b500.log","bootstrap_100_b100/wham.stdout.log"]:
    pp=Path(p)
    if pp.exists():
...
profiles={"b100":"profile_v2.xvg","b250":"profile_v2_b250.xvg","b500":"profile_v2_b500.xvg","bootstrap":"bootstrap_100_b100/profile_kjmol.xvg"}
summary=[]
spans=[]
...
Path("wham_v2_warning_lines.txt").write_text("\n".join(warning_lines)+("\n" if warning_lines else ""))
PY
cat wham_v2_qc_summary.tsv
