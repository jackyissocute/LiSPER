...
This folder is reserved for future eCPX surface-display plasmid designs.

No eCPX plasmids are designed yet.

Before designing plasmids, use:

- `../assays/surface_display_assays/whole_cell_LiNa_binding_assay_plan.md`
