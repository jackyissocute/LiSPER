...
**Active path:** buy synthetic LiSPER peptides from a commercial peptide vendor (GenScript or another reliable China peptide company), confirm QC, run Li+/Na+ binding assays, compare experimental ranking with computational alchemical free-energy ranking, then shortlist candidates for Track B surface display.
...
flowchart TD
    ...
    accDescr: Track A orders synthetic peptides from a commercial vendor, confirms QC, runs Li and Na binding assays, compares with alchemical free-energy ranking, and selects Track B candidates.

    ranking["Computational<br/>alchemical free-energy ranking"]
    order["Order peptides<br/>GenScript / China vendor"]
    qc["Vendor + lab<br/>peptide QC"]
    assay["Direct Li/Na<br/>binding assays"]
    compare["Experiment vs<br/>free-energy comparison"]
...
5. Analyze and compare with alchemical free-energy ranking (`protocols/03_data_analysis_interpretation.md`).
